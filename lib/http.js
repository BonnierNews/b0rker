...
async function performRequest(method, params) {
  ...
  const opts = {
    ...
    headers: { ...defaultHeaders(), ...(params.headers ?? {}), ...authHeaders },
...
function defaultHeaders() {
  ...
  return {
    ...
    ...(config.setXThrottle && { "x-throttle": "yes" }),
  };
}
...
function buildBackends() {
  const unAsserted = {
    head: performRequest.bind(null, "HEAD"),
    get: performRequest.bind(null, "GET"),
    patch: performRequest.bind(null, "PATCH"),
    post: performRequest.bind(null, "POST"),
    put: performRequest.bind(null, "PUT"),
  ...
  return {
    ...unAsserted,
    asserted: {
      head: withAssertion.bind(withAssertion, "HEAD", unAsserted.head),
      get: withAssertion.bind(withAssertion, "GET", unAsserted.get),
      patch: withAssertion.bind(withAssertion, "PATCH", unAsserted.patch),
      post: withAssertion.bind(withAssertion, "POST", unAsserted.post),
      put: withAssertion.bind(withAssertion, "PUT", unAsserted.put),
      del: withAssertion.bind(withAssertion, "DELETE", unAsserted.del),
    },
  };
}
