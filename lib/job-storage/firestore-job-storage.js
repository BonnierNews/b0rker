...
async function completedChild(child, { correlationId, parentCorrelationId, key }) {
  ...
  try {
    const res = await db.runTransaction(async (t) => {
      ...
      const { allChildrenComplete, completedJobs } = completedCheck(parentCorrelationId, correlationId, data);
...
async function completedCheck(parentCorrelationId, correlationId, parentData) {
